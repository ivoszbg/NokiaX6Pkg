...
Physical Memroy Array System Boot Information (Type 32)
  ...
  Copyright (c), 2021, Ivaylo Ivanov <ivo.ivanov.ivanov1@gmail.com>
...
CHAR8 *mBIOSInfoType0Strings[] = {"Nokia", // Vendor String
...
CHAR8 *mSysInfoType1Strings[] = {
    "Nokia Corporation", "6.1 Plus", "636", "Not Specified",
    "SDM636_DRG",        "Nokia",        NULL};
...
CHAR8 *mBoardInfoType2Strings[] = {
    "Nokia Corporation", "6.1 Plus", "Not Specified", "Not Specified", "Not Specified", "Not Specified", NULL};
...
CHAR8 *mEnclosureInfoType3Strings[] = {"Nokia Corporation", "Not Specified", "Not Specified", "Not Specified",
                                       NULL};
...
CHAR8 *mProcessorInfoType4Strings[] = {
    "Qualcomm", "Qualcomm Technologies Inc", "Snapdragon (TM) 636 @ 1.8 GHz",
    "SDM636", NULL};
